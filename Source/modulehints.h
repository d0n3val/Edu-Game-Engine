...
public:
	enum Hint
	{
        ...
        DIST_FOG_CURVE,
        DIST_FOG_BLUR,
        HEIGHT_FOG_GLOBAL_DENSITY,
        HEIGHT_FOG_DENSITY_FALLOFF,
        HEIGHT_FOG_COLOR,
        HEIGHT_FOG_SUN_COLOR,
        RAYMARCHING_AMBIENT_COLOUR,
        RAYMARCHING_EXTINCTION_COEFF,
        RAYMARCHING_FOG_INTENSITY,
        RAYMARCHING_STEP_SIZE,
        RAYMARCHING_ATT_CORRECTION,
