...
public:
	...
	UID ImportTexture(const char* file_name, bool mipmaps, bool toCubemap);
	UID ImportCubemap(const std::string file_names[], const std::string& user_name, bool mipmaps);
